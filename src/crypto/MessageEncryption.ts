 ...
 * 
 * Architecture:
 * - Room Key: 32-byte secret shared among room members
 * - Room ID/Topic: hash(room key) - public, used for P2P discovery
 * - Messages: Encrypted in RN before sending to worklet
 * - Root Peer: Stores encrypted messages, cannot decrypt (no room key)
 */
